...
```{r horse-sd, echo=FALSE, message=FALSE}
horses_sd_table <- read_csv("../../results/horses_sd.csv")
largest_sd <- horses_sd_table$Province[1]
knitr::kable(horses_sd_table, caption = "Provinces with the highest spread of horse populations")
```
...
Additionally, note that in Table \@ref(tab:horse-sd) we consider the sample standard deviation of the number of horses during the same time span as Figure \@ref(fig:horse-plot).

```{r horse-largest-sd-plot, fig.cap="Horse populations for the province with the largest standard deviation", out.height='60%', out.width='60%', echo=FALSE}
